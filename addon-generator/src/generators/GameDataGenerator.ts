...
export class GameDataGenerator {
   ...
   */
  generate(tools: ToolData[], foods: FoodData[], ores: OreData[], wikiItems: WikiItemData[], hammerMining: HammerMiningData[], brassSifter: BrassSifterData[], allItems: string[], edibleItems?: string[], customPath?: string): void {
    const content = this.generateContent(tools, foods, ores, wikiItems, hammerMining, brassSifter, allItems, edibleItems || []);
   ...
   */
  private generateContent(tools: ToolData[], foods: FoodData[], ores: OreData[], wikiItems: WikiItemData[], hammerMining: HammerMiningData[], brassSifter: BrassSifterData[], allItems: string[], edibleItems: string[]): string {
    return `/**
