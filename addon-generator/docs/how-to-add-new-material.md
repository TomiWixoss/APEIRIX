...
wikiDescription: lang:wiki.materials.{material}_ingot
...
### 7.2. Wiki Descriptions (vi_VN)
```yaml
# configs/script-lang/vi_VN/wiki/materials.yaml
{material}_ingot: "Mô tả chi tiết về thỏi {material} bằng tiếng Việt."
{material}_ore: "Mô tả chi tiết về quặng {material} bằng tiếng Việt."
# ... thêm description cho tất cả items
```

### 7.3. Wiki Descriptions (en_US)
```yaml
# configs/script-lang/en_US/wiki/materials.yaml
{material}_ingot: "Detailed description of {material} ingot in English."
{material}_ore: "Detailed description of {material} ore in English."
# ... add descriptions for all items
```

### 7.4. Tools Lang (vi_VN)
```yaml
